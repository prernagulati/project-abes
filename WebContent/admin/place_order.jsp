...
<html>
    ...
    try{
      ...
      PreparedStatement ps=con.prepareStatement("update order_item set status='"+dispatched+"' where o_id='"+o_id+"'");
      ps.executeUpdate();
      ...
      %>
        ...
        <table style=" width: 840px" border="0">
                    ...
                    <tr>
                        <td>
                            WS Retail Services Pvt. Ltd. Regd Office: Makum Chinapatty, Opposite Makum Police Station, Tinsukia, Assam - 786170
                        </td>
                    </tr>
                    <tr>
                        <td>
